function [] = PreprocessData(loc, num_each, num_test, matPATH, fileType, numFolders)
...
f_filtered_normalized_dwsp_vector_allsub_train = zeros(dwsp*dwsp*s*o, total_train);
f_filtered_normalized_dwsp_vector_allsub_test = zeros(dwsp*dwsp*s*o, total_test);
train_i = 1;
test_i = 1;
...
%%
display(['Processing Images... Please Hold']);
...
%%%%%%%%%%%z-score%%%%%%%%%%%
STD=std(f_filtered_normalized_dwsp_vector_allsub_train,[],2);
MEAN=mean(f_filtered_normalized_dwsp_vector_allsub_train,2);
f_filtered_normalized_dwsp_vector_allsub_train=bsxfun(@minus, f_filtered_normalized_dwsp_vector_allsub_train, MEAN);
f_filtered_normalized_dwsp_vector_allsub_train=bsxfun(@rdivide, f_filtered_normalized_dwsp_vector_allsub_train, STD+.1);
f_filtered_normalized_dwsp_vector_allsub_test=bsxfun(@minus, f_filtered_normalized_dwsp_vector_allsub_test, MEAN);
f_filtered_normalized_dwsp_vector_allsub_test=bsxfun(@rdivide, f_filtered_normalized_dwsp_vector_allsub_test, STD+.1);
%%%%%%%%%%%z-score%%%%%%%%%%%
...
%MEAN, STD, cov_scale, mean_images, total_train, mean_subst
